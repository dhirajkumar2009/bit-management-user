...
import Bit from "../assets/Bit-image2.jpg";
...
const Homepage = () => {
  ...
  style={{ 
    width: '100%', 
    border: '3px solid #7f56da', // Change color as desired
    borderRadius: '15px', // Adjust for roundness
    boxShadow: '0 4px 10px #7f56da', // Add a shadow for depth
  }} 
/>
                </Grid>
